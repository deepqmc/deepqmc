...
The software suite includes a general neural network wave function ansatz, that can be configured to obtain a wide range of molecular neural network wave functions. Config files for the instantiation of variants of [Psiformer](https://arxiv.org/abs/2211.13672), [PauliNet](https://doi.org/10.1038/s41557-020-0544-y), [FermiNet](https://link.aps.org/doi/10.1103/PhysRevResearch.2.033429), [LapNet](https://doi.org/10.1038/s42256-024-00794-x) and a transferable extension of the self-attention ansatz [TransPsiformer](https://arxiv.org/abs/2503.19847) can be found under `src/deepqmc/conf/ansatz`.
